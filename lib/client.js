...
class Client {
  ...
  dropDatabase() {
    ...
    return this._influx.query(ql.dropDatabase(this._options.database)).then(_
      .noop);
  }
  ...
  createDatabase() {
    const ql = new InfluxQL();
    return this._influx.query(ql.createDatabase(this._options.database)).then(
      _.noop);
  }
  ...
  createDatabaseNotExists() {
    const ql = new InfluxQL();
    return this._influx.query(ql.createDatabaseNotExists(this._options.database))
      .then(_.noop);
  }
